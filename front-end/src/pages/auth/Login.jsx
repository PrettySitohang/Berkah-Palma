        ...
        <div className="w-screen h-screen flex flex-col justify-center items-center relative p-5 font-sans antialiased overflow-hidden m-0">
            ...
            <div className="relative z-10 w-full max-w-[380px] flex flex-col items-center">
                ...
                <div className="bg-white w-full rounded-[1.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-7 md:p-8">
                    ...
                    {error && (
                        <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6 rounded-xl text-sm text-red-700">
                            <div className="flex items-start gap-3">
                                <BsFillExclamationDiamondFill className="text-red-500 text-xl mt-0.5" />
                                <span>{error}</span>
                            </div>
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <input
                                ...
                                /* Ditambahkan 'text-black' agar tulisan input berwarna hitam */
                                className="w-full border border-slate-200 rounded-xl px-4 py-3 text-[14px] text-black focus:outline-none focus:border-[#2a4530] focus:ring-1 focus:ring-[#2a4530] transition-colors placeholder:text-slate-400"
                                required
                            />
                        </div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                /* Ditambahkan 'text-black' agar tulisan input berwarna hitam */
                                className="w-full border border-slate-200 rounded-xl pl-4 pr-12 py-3 text-[14px] text-black focus:outline-none focus:border-[#2a4530] focus:ring-1 focus:ring-[#2a4530] transition-colors placeholder:text-slate-400"
                                required
                            />
                            <button
                                type="button"
                        ...
                        <div className="flex items-center justify-between text-[11px] md:text-[12px] pt-1">
                            ...
                            <Link to="#" className="text-slate-500 hover:text-[#2a4530] transition-colors">Lupa Kata Sandi?</Link>
                        </div>
                        ...
                        <div className="pt-3">
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-[#2a4530] hover:bg-[#1e3223] text-white font-bold py-3 text-[14px] rounded-full transition-all active:scale-[0.98] shadow-lg shadow-black/10 flex items-center justify-center gap-2"
                            >
                                {loading ? (
                                    <>
